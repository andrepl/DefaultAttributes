...
import net.minecraft.server.v1_7_R1.ItemCloth;
import net.minecraft.util.com.google.common.collect.Multimap;

public class ModifiedItemCloth extends ItemCloth {
	private final Multimap<String, AttributeModifier> modifiers;

	public ModifiedItemCloth(ItemCloth item, Multimap<String, AttributeModifier> modifiers) throws IllegalAccessException {
