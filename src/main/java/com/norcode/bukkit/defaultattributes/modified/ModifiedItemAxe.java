...
import net.minecraft.server.v1_7_R1.ItemAxe;
import net.minecraft.util.com.google.common.collect.Multimap;

public class ModifiedItemAxe extends ItemAxe {
	Multimap<String, AttributeModifier> modifiers;

	public ModifiedItemAxe(ItemAxe item, Multimap<String, AttributeModifier> modifiers) {
