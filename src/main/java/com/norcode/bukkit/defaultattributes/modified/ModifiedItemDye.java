...
import net.minecraft.server.v1_7_R1.ItemDye;
import net.minecraft.util.com.google.common.collect.Multimap;

public class ModifiedItemDye extends ItemDye {
	private final Multimap<String, AttributeModifier> modifiers;

	public ModifiedItemDye(ItemDye item, Multimap<String, AttributeModifier> modifiers) throws IllegalAccessException {
		super();
