...
import net.minecraft.server.v1_7_R1.ItemLeash;
import net.minecraft.util.com.google.common.collect.Multimap;

public class ModifiedItemLeash extends ItemLeash {
	private final Multimap<String, AttributeModifier> modifiers;

	public ModifiedItemLeash(ItemLeash item, Multimap<String, AttributeModifier> modifiers) throws IllegalAccessException {
		super();
