...
import net.minecraft.server.v1_7_R1.ItemWaterLily;
import net.minecraft.util.com.google.common.collect.Multimap;

public class ModifiedItemWaterLily extends ItemWaterLily {
	private final Multimap<String, AttributeModifier> modifiers;

	public ModifiedItemWaterLily(ItemWaterLily item, Multimap<String, AttributeModifier> modifiers) throws IllegalAccessException {
