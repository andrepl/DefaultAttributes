...
import net.minecraft.server.v1_7_R1.ItemAnvil;
import net.minecraft.util.com.google.common.collect.Multimap;

public class ModifiedItemAnvil extends ItemAnvil {
	private final Multimap<String, AttributeModifier> modifiers;

	public ModifiedItemAnvil(ItemAnvil item, Multimap<String, AttributeModifier> modifiers) throws IllegalAccessException {
