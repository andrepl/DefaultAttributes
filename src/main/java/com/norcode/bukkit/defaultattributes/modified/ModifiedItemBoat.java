...
import net.minecraft.server.v1_7_R1.ItemBoat;
import net.minecraft.util.com.google.common.collect.Multimap;

public class ModifiedItemBoat extends ItemBoat {
	private final Multimap<String, AttributeModifier> modifiers;

	public ModifiedItemBoat(ItemBoat item, Multimap<String, AttributeModifier> modifiers) throws IllegalAccessException {
		super();
