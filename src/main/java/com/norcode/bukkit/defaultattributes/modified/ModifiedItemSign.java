...
import net.minecraft.server.v1_7_R1.ItemSign;
import net.minecraft.util.com.google.common.collect.Multimap;

public class ModifiedItemSign extends ItemSign {
	private final Multimap<String, AttributeModifier> modifiers;

	public ModifiedItemSign(ItemSign sign, Multimap<String, AttributeModifier> modifiers) {
		super();
