...
import net.minecraft.server.v1_7_R1.ItemBed;
import net.minecraft.util.com.google.common.collect.Multimap;

public class ModifiedItemBed extends ItemBed {
	private final Multimap<String, AttributeModifier> modifiers;

	public ModifiedItemBed(ItemBed item, Multimap<String, AttributeModifier> modifiers) throws IllegalAccessException {
		super();
