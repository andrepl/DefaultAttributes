...
public class ModifiedItemEnderPearl extends ItemEnderPearl {
	private final Multimap<String, AttributeModifier> modifiers;

	public ModifiedItemEnderPearl(ItemEnderPearl item, Multimap<String, AttributeModifier> modifiers) throws IllegalAccessException {
		super();
